...
/* Thumbnailpack removal */
   ...
   MENU_LABEL(MANUAL_CONTENT_SCAN_FILE_PATTERNS),
   MENU_LABEL(MANUAL_CONTENT_SCAN_TITLE_PATTERN),
   MENU_LABEL(MANUAL_CONTENT_SCAN_SCAN_DEPTH),
   MENU_LABEL(MANUAL_CONTENT_SCAN_USE_DIRNAME_FOR_LABEL),
